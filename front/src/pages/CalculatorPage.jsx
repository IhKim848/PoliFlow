    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-4 md:p-8">
        ...
        <div className="w-full max-w-3xl mt-16 md:mt-0">
          ...
          <div className="bg-white p-6 md:p-10 rounded-2xl shadow-xl w-full border border-gray-100">
            ...
            {result && (
              <div className="mt-8 space-y-6 animate-fade-in-up">
                ...
                <div className="bg-gray-50 p-6 rounded-xl border border-gray-100">
                  <h3 style={{ fontSize: '20px' }} className="font-bold text-gray-800 mb-4 flex items-center gap-2">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-base">
                    <div className="flex flex-col bg-white p-3 rounded-lg shadow-sm">
                      ...
                      <span style={{ fontSize: '16px' }} className="font-semibold text-gray-800">{result.profile.age || 0}세</span>
                    </div>
                    <div className="flex flex-col bg-white p-3 rounded-lg shadow-sm">
                      <span className="text-gray-500 text-xs mb-1">거주 지역</span>
                      <span style={{ fontSize: '16px' }} className="font-semibold text-gray-800">{result.profile.location || '알 수 없음'}</span>
                    </div>
                    <div className="flex flex-col bg-white p-3 rounded-lg shadow-sm">
                      <span className="text-gray-500 text-xs mb-1">혼인 여부</span>
                      <span style={{ fontSize: '16px' }} className="font-semibold text-gray-800">{result.profile.martial_status || '미혼'}</span>
                    </div>
                    <div className="flex flex-col bg-white p-3 rounded-lg shadow-sm">
                      <span className="text-gray-500 text-xs mb-1">연소득</span>
                      <span style={{ fontSize: '16px' }}  className="font-semibold text-gray-800">
                    ...
                    <div className="flex flex-col bg-white p-3 rounded-lg shadow-sm">
                      ...
                      <span style={{ fontSize: '16px' }} className="font-semibold text-gray-800">{result.profile.homeless_year || 0}년</span>
                    </div>
                    <div className="flex flex-col bg-white p-3 rounded-lg shadow-sm">
                      <span className="text-gray-500 text-xs mb-1">유주택 세대원</span>
                      <span style={{ fontSize: '16px' }} className="font-semibold text-gray-800">{result.profile.has_house_in_family ? '있음' : '없음'}</span>
                    </div>
                    <div className="flex flex-col bg-white p-3 rounded-lg shadow-sm">
                      <span className="text-gray-500 text-xs mb-1">청약통장 가입</span>
                      <span style={{ fontSize: '16px' }} className="font-semibold text-gray-800">{result.profile.subscription_years || 0}년</span>
                    </div>
                    <div className="flex flex-col bg-white p-3 rounded-lg shadow-sm">
                      <span className="text-gray-500 text-xs mb-1">부양가족 수</span>
                      <span style={{ fontSize: '16px' }} className="font-semibold text-gray-800">{result.profile.dependents_count || 0}명</span>
                    </div>
                  </div>
                </div>
